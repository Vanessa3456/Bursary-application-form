...
class Rattansi(models.Model):
        ...
        telNo= models.IntegerField(max_length=10),
        ...
        next_of_kin_no=models.IntegerField(max_length=10),
        
        # chief details
        name_of_chief= models.CharField(max_length=100),
        name_of_chief_adress=models.CharField(max_length=200),
        name_of_chief_no=models.IntegerField(max_length=10)
        ...
        deferment_reason= models.CharField(max_length=50, blank=True, null=True,choices=[(
            ('medical','Medical'),('socail','Socail'),('financial','Finacial'),('academic','Academic'),
        )])
